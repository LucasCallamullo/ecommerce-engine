...
/// <summary>
/// Validator responsible for enforcing conditional business rules on master product update requests.
/// </summary>
public class ProductUpdateValidator : AbstractValidator<ProductUpdateRequest>
{
    /// <summary>
    /// Initializes validation rules for <see cref="ProductUpdateRequest"/>.
    /// </summary>
...
/// <summary>
/// Validator responsible for enforcing validation rules on variant update payloads.
/// </summary>
public class ProductVariantUpdateValidator : AbstractValidator<ProductVariantUpdateRequest>
{
    /// <summary>
    /// Initializes validation rules for <see cref="ProductVariantUpdateRequest"/>.
    /// </summary>
