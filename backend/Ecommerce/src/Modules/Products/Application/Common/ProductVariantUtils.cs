...
public static class ProductVariantUtils
{
    ...
    /// <summary>
    /// Maps common color names (Spanish and English) to standard HEX color codes.
    /// Returns null if the color name is unrecognized.
    /// </summary>
    public static string? ResolveHexColor(string? colorName)
    {
        ...
        return ColorHexMap.TryGetValue(key, out var hex) ? hex : null;
    }
